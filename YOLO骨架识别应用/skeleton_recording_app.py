...
class SkeletonRecordingApp:
    ...
    def draw_ui(self, frame):
        ...
        # 绘制控制说明
        cv2.putText(frame, "按 'r' 开始/停止录制, 'c' 切换卡通形象, 'q' 退出", (20, 110), 
    ...
    def process_frame(self, frame, confidence_threshold=0.5):
        ...
        if results[0].keypoints is not None:
            ...
            cv2.putText(frame, f"检测到 {num_persons} 个人", (10, 150), 
        ...
        try:
            while True:
                ...
                if frame_count % 30 == 0:
                    ...
                    cv2.putText(frame, f"FPS: {fps:.1f}", (10, 180), 
                               cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
                
                # 显示帧
                cv2.imshow('YOLO骨架识别录制应用', frame)
